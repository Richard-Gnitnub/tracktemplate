"""Show B14's trackwork manager non-modally in the dedicated session."""
...
if module is None:
    raise RuntimeError("Load B14 with load_b14.py before showing the manager")

manager = getattr(module, "_automation_trackwork_manager", None)
if manager is None:
    document = App.ActiveDocument or App.newDocument("TrackTemplateBenchmark")
