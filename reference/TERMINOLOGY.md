...
| **Classify** | Assign a failed check to one failure class that the testing policy gives. Assign one local-state inventory item to one of the five types that the recovery policy gives. |
