...
- [S1_PILOT_PLAN.md](phase-evidence/S1_PILOT_PLAN.md) owns the accepted first-package
...
The owner-accepted [first S1 pilot plan](phase-evidence/S1_PILOT_PLAN.md) fixes the intended uses,
