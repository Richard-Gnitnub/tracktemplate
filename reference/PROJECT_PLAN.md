...
[current/gate-decisions.json](current/gate-decisions.json) is the structured
record. Detailed review evidence stays in the current phase file.
...
- [Current Phase 4 evidence](current/PHASE_EVIDENCE.md)
