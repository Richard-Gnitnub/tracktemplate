...
- [LICENSING_BOUNDARIES.md](LICENSING_BOUNDARIES.md) defines the mandatory
  ...
  statuses.
- [PHASE1_INVENTORY.md](phase-evidence/PHASE1_INVENTORY.md) records the accepted Phase 1
  workflow, dependency, side-effect, candidate and decision evidence.
- [PHASE1_CLOSEOUT.md](phase-evidence/PHASE1_CLOSEOUT.md) records the accepted Phase 1
  evidence, risks, deferrals, owner decisions and bounded Phase 2 authority.
- [PHASE2_FOUNDATION.md](phase-evidence/PHASE2_FOUNDATION.md) records the accepted loading,
  dependency and comparison foundation.
- [PHASE3_TRANSITION_SLICE.md](phase-evidence/PHASE3_TRANSITION_SLICE.md) records the accepted
  transition-length extraction, parity, performance and closeout evidence.
- [PHASE4_CANONICAL_STATE.md](phase-evidence/PHASE4_CANONICAL_STATE.md) is the one live Phase
...
[PHASE1_INVENTORY.md](phase-evidence/PHASE1_INVENTORY.md). Its first static tranche is
...
[first-slice scorecard](phase-evidence/PHASE1_SLICE_SCORECARD.md) selected the three-function
...
decision are recorded in [PHASE1_INVENTORY.md](phase-evidence/PHASE1_INVENTORY.md).
...
| Exit condition | State | Evidence or remaining work |
| --- | --- | --- |
| Standalone Python imports the domain/API boundary without FreeCAD or Qt | Evidenced | Isolated import and forbidden-import checks in `tests/validate_phase2_foundation.py`; result recorded in [PHASE2_FOUNDATION.md](phase-evidence/PHASE2_FOUNDATION.md) |
| The launcher loads the package in the qualified FreeCAD environment | Evidenced | Zero-document-mutation FreeCAD smoke in `tests/freecad_validate_phase2_foundation.py`; loading route recorded in [PHASE2_FOUNDATION.md](phase-evidence/PHASE2_FOUNDATION.md) |
| Existing B14/B15 workflows and validation remain unchanged | Evidenced | Exact B14/B15 hashes and the applicable fast and FreeCAD regression results are recorded in [PHASE2_FOUNDATION.md](phase-evidence/PHASE2_FOUNDATION.md) |
...
| The first package has a recorded maintainability/reuse review | Evidenced | Authority, interfaces, dependency direction and retirement gates are recorded in [PHASE2_FOUNDATION.md](phase-evidence/PHASE2_FOUNDATION.md) |
...
[PHASE2_FOUNDATION.md](phase-evidence/PHASE2_FOUNDATION.md) on 2026-07-22, closing Phase 2 and
...
| Exit condition | State | Evidence or remaining work |
| --- | --- | --- |
| The selected capability follows target dependency direction and its domain portion imports without FreeCAD/Qt | Evidenced | Exact three-function extraction in `tracktemplate.domain.alignment`; isolated import and structure guards recorded in [PHASE3_TRANSITION_SLICE.md](phase-evidence/PHASE3_TRANSITION_SLICE.md) |
...
| First extraction slice | Resolved and accepted at Phase 3 closeout on 2026-07-22; the Phase 4 comparison-route retirement was accepted on 2026-07-27 under bounded conditions | Candidate contracts, bounded closure cuts, workflow/performance profiles, scorecard, [PHASE3_TRANSITION_SLICE.md](phase-evidence/PHASE3_TRANSITION_SLICE.md), the [Phase 4 panel and evidence](phase-evidence/PHASE4_CANONICAL_STATE.md) and separate owner decisions |
...
| PR-02 | **P:** label the five-box body as legacy gap evidence and keep S1 production blocked. **D:** B15 and S1-plan validators. **R:** reject production-ready claims or fallback use. | Effective (current scope) | [S1_PILOT_PLAN.md](phase-evidence/S1_PILOT_PLAN.md) and [VALIDATION.md](VALIDATION.md) distinguish the approximation and block the package. **Next proof:** Phase 4 schema rejection plus Phase 9 constituent-generation/oracle evidence. |
| PR-03 | **P:** canonical definitions exclude retained scan/CAD bodies. **D:** calibration, residual, identity and provenance checks. **R:** reject/quarantine ambiguous evidence. | Partial | The boundary is specified in [ARCHITECTURE.md](ARCHITECTURE.md) and [S1_PILOT_PLAN.md](phase-evidence/S1_PILOT_PLAN.md), but no accepted schema/pilot has exercised it. **Next proof:** fail-closed Phase 4 package tests and the accepted Phase 9 pilot. |
| PR-04 | **P:** require independent measurements/drawings and operator landmarks. **D:** explicit unknown, rail-fit and residual checks. **R:** preserve unresolved status and reject unsupported confidence. | Partial | The policy and blocked decisions exist in [S1_PILOT_PLAN.md](phase-evidence/S1_PILOT_PLAN.md); no assimilation result is accepted. **Next proof:** Phase 9 nominal/hidden/rail-interface evidence and owner acceptance. |
| PR-05 | **P:** dependency approval and optional adapter isolation. **D:** structural dependency checks and clean-runtime loading. **R:** disable optional import/fitting while retaining definition generation. | Effective (current scope) | The current package is structurally clean under [MODULARISATION_PLAN.md](MODULARISATION_PLAN.md) and [PHASE2_FOUNDATION.md](phase-evidence/PHASE2_FOUNDATION.md); chair tools do not yet exist. **Next proof:** Phase 9 generation without source tooling and Phase 10 clean Addon installation. |
...
| PR-18 | **P:** named owner and retirement gate for every dual path. **D:** inventory/structural checks and phase-close review. **R:** explicit legacy rollback only until retirement evidence passes. | Effective (current scope) | The transition comparison route was retired and owner-accepted on 2026-07-27 under the [Phase 4 panel conditions](phase-evidence/PHASE4_CANONICAL_STATE.md). The B16 product path is modular-only and lazy, while the dual route is development-oracle tooling. **Next proof:** later per-slice removals and Phase 10 absence of unowned production duplication. |
...
| PR-22 | **P:** mandatory timing, roles, evidence inputs and exact panel outcomes before closeout. **D:** QA-policy and prospective progress validation plus recorded challenge review. **R:** default to `Do not proceed`, leave/reopen the gate and update due risks before reconsideration. | Effective (current scope) | The first prospective [Phase 4 panel](phase-evidence/PHASE4_CANONICAL_STATE.md) recorded its evidence, role overlap, bounded recommendation and separate project-owner decision on 2026-07-27. **Next proof:** repeat the panel at Phase 4 closeout and every later applicable gate. |
