...
| D-GOV-012 | 2026-08-25 | Accepted | The [decision](current/PHASE_EVIDENCE.md#d-gov-012-worktree-sequence-nonconformance) records the sequence nonconformance for the completed worktree retirement. It accepts named-source preservation and authorises one Cycle 2 repair candidate and draft pull request. It authorises no integration. |
