...
functions = {name: getattr(api, name) for name in exit_proof.FUNCTION_NAMES}

original_core = host.module.build_concentric_core
host.module.build_concentric_core = exit_proof.detached_core(
...
host.module.build_concentric_core = original_core
...
assert record["function_names"] == list(exit_proof.FUNCTION_NAMES)
