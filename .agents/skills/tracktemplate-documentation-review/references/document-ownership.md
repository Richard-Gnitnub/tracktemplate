# TrackTemplate document ownership

Use this map to identify the single canonical owner before creating, moving, shortening or deleting documentation.
...
Accepted closeouts, inventories, baselines, contracts and foundation records are historical evidence rather than live project-status documents. Preserve their dated meaning, and link to the live canonical owner instead of updating them as though they owned current status.
