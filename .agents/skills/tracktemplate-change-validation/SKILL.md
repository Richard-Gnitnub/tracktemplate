...
Select and report the evidence required by the actual TrackTemplate change
without running an indiscriminate whole-repository suite or claiming acceptance
