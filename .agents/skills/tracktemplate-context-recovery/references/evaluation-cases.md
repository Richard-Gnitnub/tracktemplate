...
| --- | --- | --- | --- | --- |
| CE-01 current status | What phase is current and which gates remain open? | [`AGENTS.md`](../../../../AGENTS.md) and [`PROJECT_PLAN.md`](../../../../reference/PROJECT_PLAN.md) | Exact phase state, gate evidence state and named open-phase record | Deriving phase status from commits, progress prose in another document or a conversation summary |
